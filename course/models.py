...
class Course(models.Model):
    user = models.ForeignKey(User, related_name="courses_user", on_delete=True)
...
class Lesson(models.Model):
    user = models.ForeignKey(User, related_name='lesson_user', on_delete=True)
    course = models.ForeignKey(Course, related_name='lesson', on_delete=True)
    title = models.CharField(max_length=200)
